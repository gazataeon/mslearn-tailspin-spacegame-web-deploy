  ...
  <xsl:template match="/testResults">
    ...
    <testsuite>
      ...
      <testcase>
          ...
          <xsl:attribute name="time"><xsl:value-of select="format-number($avg-time div 3000,'#.##')"/></xsl:attribute>
      ...
      <testcase>
          ...
          <xsl:attribute name="time"><xsl:value-of select="math:max($times) div 3000"/></xsl:attribute>
